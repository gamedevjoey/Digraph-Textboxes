...
var textboxEditerVisible = false;
...
class Graph extends Component {
  ...
  //same as the Oncreate node but type is set to textbox
  onCreateTextbox = (x, y) => {
    const graph = this.state.graph;
  ...
  //this overrides the default funcion
  ...
  renderNodeTextbox(data) {
    //if type is textbox override regualr function (NOT DONE YET)
    //run the nodes title as html code
    return (
      <foreignObject x="-30" y="-30" width="500" height="1" overflow="visible">
        <div className="node">
          <div dangerouslySetInnerHTML={{ __html: data.title }} />
        </div>
      </foreignObject>
